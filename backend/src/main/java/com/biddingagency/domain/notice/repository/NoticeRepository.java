...
public interface NoticeRepository extends JpaRepository<Notice, UUID> {
     ...
     */
    @Query("SELECT n FROM Notice n JOIN n.opportunity o WHERE n.visibility = :visibility "
    ...
    /** 고객 상세 — 노출 공고문 단건 */
    Optional<Notice> findByIdAndVisibility(UUID id, OpportunityVisibility visibility);
